...
//    YOGA_ANSWER("Смотрите, что я Вам нашла", "^Смотрите^, что я вам нашла"),
    ...
    NUMBER_COUNT_TASK_ANSWER_NOT_NUMBER("Вы должны выбрать число", "Вы должны выбрать число"),
    NUMBER_COUNT_TASK_ANSWER_LESS_ONE("Число должно быть больше 1", "Число должно быть больше 1"),
    NUMBER_COUNT_TASK_ANSWER_GREATER_ONE_HUNDRED("Число должно быть меньше или равняться 100", "Число должно быть меньше или равняться 100"),
    NUMBER_COUNT_TASK_ANSWER_START_GAME("Давайте я начну! Один", "Давайте я начну! Один"),
    NUMBER_COUNT_TASK_ANSWER_END_GAME("Мы досчитали до конца. Отличная работа! Можем сыграть снова или вы можете выбрать что-то другое",
            "Мы досчитали до конца. Отличная работа! Можем сыграть снова или вы можете выбрать что-то другое"),
//    NUMBER_COUNT_TASK_ANSWER("К сожалению, эта функция сейчас недоступна", "К сожалению, эта функция сейчас недоступна."),
    ...
    //FIXME В колонке не мб видео
    VIDEO_ANSWER("Посмотрите это видео\n https://www.youtube.com/watch?v=q1NuROtXxso.\n Другие видео скоро будут добавлены",//todo add more
