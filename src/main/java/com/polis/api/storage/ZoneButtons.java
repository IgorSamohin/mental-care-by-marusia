...
public enum ZoneButtons {
    @Deprecated
    REPEAT("Ещё", "Повтори"),//fixme эта зона отличается от остальных - ее нужно вынести в отдельный класс
    ...
    DISTRACTION("Йога", "Счет чисел", "Угадывание чисел"),
    SEDATION("Скинь видео", "Включи музыку", "Звуки", "Дыхательное упражнение"),
    GUESS_GAME("Да", "Нет"),
    GAME_STOP("Больше не хочу"),
