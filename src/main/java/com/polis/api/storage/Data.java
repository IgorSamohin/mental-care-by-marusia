...
public class Data {
    ...
    private static final String[] EXIT_COMMANDS = new String[]{"пока", "выйди", "хочу выйти", "стоп", "все", "хватит"};
    private static final String[] HOME_COMMANDS = new String[]{"начало", "вернись в начало", "заново", "давай по новой"};
    ...
    static {
        ...
        states.put(
                -1, new State(-1, MarusiaAnswer.START_STATE_ANSWER.text, MarusiaAnswer.START_STATE_ANSWER.tts, new Transition[]{
                        new Transition(-3, EXIT_COMMANDS),
        ...
        states.put(
                0, new State(0, MarusiaAnswer.DISTRACTION_STATE_ANSWER.text, MarusiaAnswer.DISTRACTION_STATE_ANSWER.tts, new Transition[]{
                        new Transition(-3, EXIT_COMMANDS),
                        new Transition(-1, HOME_COMMANDS),
