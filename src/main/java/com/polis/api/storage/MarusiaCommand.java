...
public enum MarusiaCommand {
    ...
    MORE("Еще", "Давай еще", "Давай еще раз", "Повтори"),
    ...
    HELP_SEDATION("Успокоение", "как ты можешь меня успокоить", "как ты можешь успокоить",
            "как можешь успокоить"), // возможно одинаковое с SEDATION
    HELP_DISTRACTION("Отвлечение", "как ты можешь меня отвлечь", "как ты можешь отвлечь",
            "как можешь отвлечь"), // возможно одинаковое с DISTRACTION

    SEDATION("Успокой", "хочу успокоиться", "успокой меня", "успокоение", "как ты можешь меня успокоить",
